...
class ScrollUpButton extends React.Component {
  ...
  render() {
    ...
    if(this.props.children){
      ...
      return(
        <aside data-testid="react-scroll-up-button" style={{ ...this.props.style, ...(this.state.ToggleScrollUp && this.props.ToggledStyle) }} className={this.props.ContainerClassName + " " + this.state.ToggleScrollUp} onClick={this.HandleClick}>
          {childrenWithProps}
        </aside>
      );
    }else{
      return(
        <aside data-testid="react-scroll-up-button" className={this.props.ContainerClassName + " " + this.state.ToggleScrollUp} style={{ ...styles.MainStyle, ...this.props.style, ...(this.state.ToggleScrollUp && styles.ToggledStyle), ...(this.state.ToggleScrollUp && this.props.ToggledStyle)}} onClick={this.HandleClick}>
...
export const TinyButton = (props)=>{
  ...
  return (
    <ScrollUpButton {...props} style={{ ...styles.MainStyle, ...props.style }} ToggledStyle={{ ...styles.ToggledStyle, ...props.ToggledStyle }}>
